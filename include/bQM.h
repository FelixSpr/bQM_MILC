// -----------------------------------------------------------------
// Defines and subroutine declarations for bosonic quantum mechanics
#ifndef _BQM_H
#define _BQM_H
...
// -----------------------------------------------------------------
// The d=1 gauge group is SU(NCOL)
// All matrices in adjoint rep with NADJ = NCOL^2 - 1 generators
#define NCOL 2
#define NADJ (NCOL * NCOL - 1)
